...
(((n << 16) >> 24) << 16) | (n >> 24))
/**
* verify- verify the file to check
...
/**
* magic - print magic number and run
* @e_ident: the ELF struct
* return: no return is a void func.
*/
...
/**
* class - print the class of the ELF and run
* @e_ident: the ELF struct
* return: no return is a void func.
*/
...
/**
* entry - print the entry point and run
* @e_ident: the ELF struct
...
/**
* main - read a ELF file and run it
